...
import { Barlow_Condensed, Manrope, Instrument_Serif, Pixelify_Sans } from 'next/font/google';
import './globals.css';
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body className={`${display.variable} ${body.variable} ${editorial.variable} ${pixel.variable}`}>{children}</body></html>}
