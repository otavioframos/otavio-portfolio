...
export function MoreWork({ lang }: { lang: Lang }) {
  ...
  return <section id="more-work" className="more-work" aria-labelledby="more-work-heading">
    ...
    <a className="compact-work-row" href="https://github.com/otavioframos/aeon" aria-labelledby="vela-title">
      ...
      <span className="compact-work-action"><span className="compact-work-status">{pt ? 'Projeto pessoal' : 'Personal project'}</span><span className="compact-work-open"><span>GitHub</span><span aria-hidden="true">↗</span></span></span>
    </a>
